...
public class FlatMapMethodDemo1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(list);
		 ...
		 l3.stream().sorted(Comparator.reverseOrder()).map(m->m+30).forEach(e->System.out.println(e));
	
		
		List<Integer> collect2 = l2.stream().sorted(Comparator.reverseOrder()).map(m->m+20).collect(Collectors.toList());
